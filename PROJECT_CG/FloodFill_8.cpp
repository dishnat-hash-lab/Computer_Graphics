...
void flood(int x, int y, struct Color old_col, struct Color new_col) {
    ...
    flood(x + 1, y + 1, old_col, new_col); // Top-right diagonal
    flood(x - 1, y + 1, old_col, new_col); // Top-left diagonal
    flood(x + 1, y - 1, old_col, new_col); // Bottom-right diagonal
    flood(x - 1, y - 1, old_col, new_col); // Bottom-left diagonal
}
...
int main(int argc, char **argv) {
    ...
    glutCreateWindow("Flood Fill 8-Connected L Shape");
